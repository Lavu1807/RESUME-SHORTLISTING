...
import { scoreResume, type ScoreResponse } from "@/lib/api"

interface ResumeUploadFormProps {
  onScoreReceived?: (score: ScoreResponse) => void
}

export function ResumeUploadForm({ onScoreReceived }: ResumeUploadFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Call backend API to score the resume
      ...
      // Call callback if provided (for inline display)
      if (onScoreReceived) {
