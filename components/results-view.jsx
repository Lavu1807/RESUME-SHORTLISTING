...
export function ResultsView({ scoreData: initialData }) {
  ...
  useEffect(() => {
    ...
    const storedScore = typeof window !== "undefined" ? sessionStorage.getItem("scoreResponse") : null
    const storedFileName = typeof window !== "undefined" ? sessionStorage.getItem("resumeFileName") : null
  ...
  const candidateName = (resumeFileName || "Resume").replace(/\.(pdf|docx)$/i, "")
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="pt-4 text-xs text-muted-foreground">
              <p>
                Analyzed using: <strong>{scoreData.method_used}</strong> method
              </p>
